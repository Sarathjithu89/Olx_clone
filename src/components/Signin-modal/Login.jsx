...
import love from "../../assets/loginEntryPointFavorite.webp";
import avatar from "../../assets/loginEntryPointChat.webp";
          ...
          >
            ...
            <Carousel
              ...
              theme={{
                ...
                scrollContainer: {
                  base: "flex h-full snap-mandatory overflow-y-hidden overflow-x-hidden scroll-smooth no-scrollbar",
                  snap: "snap-x",
                },
                control: {
                  base: "inline-flex items-center justify-center rounded-full bg-transparent p-2 border-none",
                  icon: "w-6 h-6 text-black dark:text-black bg-transparent",
                },
              }}
              onClick={(event) => {
